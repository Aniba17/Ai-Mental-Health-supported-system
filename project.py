...
def main():
    print("Welcome to the AI-powered Mental Health Support System")
    print("Please share how you're feeling today and any concerns you have.")
    ...
    if user_input:
        ...
        if "error" in response:
            ...
            print(f"**AI Counselor's Response:** {response['response']}")
